...
class App:
    ...
    def add_controlli(self, master, frame, parametre):
        ...
        ttk.Label(frame, text="String").grid(row=0, sticky=W, padx=5, pady=5)
    ...
    def create_statusBar(self,frame):
        self.status_bar = ttk.Label(frame,background="#80D0D0",relief=FLAT,text="> $ Yazuko and Lirox")
